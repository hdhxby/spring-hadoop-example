...
/**
 * @see org.springframework.data.jdbc.core.convert.SqlGenerator
 */
public class EntitySqlGenerator {
    ...
    private final EntitySqlContext sqlContext;
     ...
     */
    EntitySqlGenerator(RelationalMappingContext mappingContext, JdbcConverter converter, RelationalPersistentEntity<?> entity,
                       Dialect dialect) {

        this.mappingContext = mappingContext;
        this.entity = entity;
        this.sqlContext = new EntitySqlContext(entity);
    ...
    public String insert() {
        return createInsertSql(Stream.of(SqlIdentifier.unquoted("id")).collect(Collectors.toSet()));
    }
